...
# ultra-safe: no set -e, no functions, just sequential writes

mkdir -p app/context
mkdir -p app/components
mkdir -p "app/(tabs)"
mkdir -p app/assets/shop

# ---------- app/context/UserContext.tsx ----------
cat > app/context/UserContext.tsx <<'TS'
...
cat > app/context/AchievementsContext.tsx <<'TS'
import React, { createContext, useContext, useEffect, useMemo, useState } from "react";
import AsyncStorage from "@react-native-async-storage/async-storage";
...
# ---------- app/context/achievements-bridge.ts ----------
cat > app/context/achievements-bridge.ts <<'TS'
...
cat > app/components/UserBadge.tsx <<'TS'
...
# ---------- app/components/CoinPill.tsx ----------
cat > app/components/CoinPill.tsx <<'TS'
import React from "react";
...
cat > app/components/HeaderBar.tsx <<'TS'
import React from "react";
...
cat > app/components/AchievementCard.tsx <<'TS'
import React from "react";
...
cat > "app/(tabs)/achievements.tsx" <<'TS'
import React, { useMemo } from "react";
...
echo "Wrote all files. If you see any errors, verify asset filenames in app/assets/shop/* match the require(...) names."
