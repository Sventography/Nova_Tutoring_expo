...
export default function IslandScreen() {
  ...
  /*
   * The 3D viewport reports every touch immediately. While it is active,
   * the surrounding page may not scroll or steal a vertical orbit gesture.
   */
  const [
    sceneInteracting,
    setSceneInteracting,
      ...
      >
        ...
        <View style={styles.progressCard}>
          ...
          <View style={styles.nextRow}>
            ...
            <Text style={styles.nextText}>
              {nextUnlock
                ? `A mystery discovery awakens at Level ${nextUnlock.level}`
            ...
            <View style={{ flex: 1 }}>
              ...
              >
                {selectedUnlocked
                  ...
                  : `Reach Island Level ${selected.level} to reveal what is waiting here.`}
              </Text>
            </View>
          </View>
        )}
        ...
        <View style={styles.roadmap}>
          ...
          <Text style={styles.roadmapBody}>
            Nova Island now expands as your learning level rises. New land,
            landmarks, companions, and habitats remain hidden until the moment
            they awaken, so every major level can reveal a genuine surprise.
          </Text>
