...
import { getTokensSnapshot } from "../context/ThemeContext";
...
/* --------------------------------- Screen -------------------------------- */
export default function Shop() {  const { tokens, setThemeById } = useTheme();
  ...
  const renderItem = (it: any, color: string, equipable?: "theme" | "cursor") => {
    ...
    return (
      <Card key={it.id} color={color}>
        ...
        {it.desc ? (
          <Text style={{ color: tokens.text as any, fontSize: 12, lineHeight: 16, textAlign: "center", marginTop: 16, paddingHorizontal: 8 }} numberOfLines={3}>
            {it.desc}
          </Text>
        ) : null}
          ...
          owned ? (
            <Pressable
              ...
              style={({ pressed }) => ({
                ...
                borderColor: tokens.border as any, backgroundColor: pressed ? "rgba(92,252,200,0.15)" : "rgba(92,252,200,0.08)",
              })}
            >
    ...
    <LinearGradient colors={["#000000", "#001528"]} style={{ flex: 1 }}>
      ...
      >
        ...
        >
          ...
          >
            <Text style={{ color: tokens.text as any, fontSize: 14, fontWeight: "700" }}>{(coins ?? 0).toLocaleString()} coins</Text>
          </View>
        </View>
        ...
        {orders.length > 0 && (
          <View style={{ marginTop: 24 }}>
            <Text style={{ color: tokens.text as any, fontSize: 16, fontWeight: "800", marginBottom: 10 }}>Orders</Text>
            {orders.map((o) => (
              <View
                key={o.id}
                style={{
