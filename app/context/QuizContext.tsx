...
export default function QuizScreen() {
  console.log("🔍 QUIZ SCREEN MOUNTED FROM app/tabs/quiz.tsx");
        ...
        >
          <View style={S.modalBackdrop}>
            <LinearGradient colors={gradient} style={S.modalCard}>
              ...
              >
                80% or higher! Your certificate is ready in the Certificates tab.
              </Text>
  ...
  return renderShell(
    <>
      {/* 🔥 Big dev cheats banner so we *know* this file is used */}
      {DEV_ENABLE_QUIZ_CHEATS ? (
        ...
        >
          ...
          >
            DEV CHEATS ONLINE — app/tabs/quiz.tsx
          </Text>
        </View>
      ) : null}

      {/* 🔧 Dev cheats panel (visible while quiz running) */}
      {DEV_ENABLE_QUIZ_CHEATS && total > 0 ? (
        <View
          style={[
            S.devRow,
            {
      ...
      {choices.length === 0 ? (
        ...
        >
          ...
          >
            (No answer choices generated — check your flashcard data for this
            topic.)
          </Text>
        </View>
      ) : (
