            ...
            {TECHNIQUES.map((t) => (
              <Pressable
                ...
                style={({ pressed }) => ({
                  ...
                  borderWidth: 1,
                  borderColor:
                    t.id === techId ? PINK_ACCENT : "rgba(97,44,67,0.25)",
                  backgroundColor: pressed
                    ? "rgba(255,110,168,0.12)"
                    : t.id === techId
              ...
              >
                <Text
                  style={{
                    color: t.id === techId ? TEXT_PRIMARY : TEXT_SECONDARY,
                    fontWeight: "700",
                  }}
                >
                  {t.name}
            ...
            <View style={{ flexDirection: "row", gap: 10, marginTop: 16 }}>
              ...
              >
                <Ionicons
                  ...
                  color={PINK_ACCENT}
                />
                <Text style={{ color: PINK_ACCENT, fontWeight: "800" }}>
                  {running ? "Pause" : "Start"}
                </Text>
              </Pressable>
              ...
              <Pressable
                ...
                style={({ pressed }) => ({
                  ...
                  borderRadius: 10,
                  borderWidth: 1,
                  borderColor: "rgba(97,44,67,0.35)",
                  backgroundColor: pressed
                    ? "rgba(97,44,67,0.10)"
                    : PINK_ACCENT_SOFTER,
                })}
