...
/** 💫 Correct FX provider + overlay */
import { FxProvider } from "../context/FxProvider";   // ⬅️ path/name fixed
import FxOverlay from "../components/FxOverlay";      // ⬅️ casing/path fixed
      ...
      <CursorProvider>
        <FxProvider>
          ...
          <CollectionsProvider>
            ...
            {/* Mount overlays AFTER Tabs so they sit on top */}
            <FxOverlay />
            <StarTrailOverlay />
